...
public class Item implements Serializable{
    ...
    private int tarifaxDia;
    private String formatoRenta;
    private String genero;

    public Item(TipoItem tipo, int id, String nombre, String descripcion, Date fechaLanzamiento, int tarifaxDia, String formatoRenta, String genero) {
        this.tipo = tipo;
        this.id = id;
        this.nombre = nombre;
    ...
    public void setTarifaxDia(int tarifaxDia) {
        this.tarifaxDia = tarifaxDia;
    }
